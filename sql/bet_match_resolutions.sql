...
-- ALTER TABLE bet_match_resolutions MODIFY bull_credit TEXT;
-- ALTER TABLE bet_match_resolutions MODIFY bear_credit TEXT;
-- ALTER TABLE bet_match_resolutions MODIFY settled TEXT;